...
VIDEOSIZE="${SE_SCREEN_WIDTH:-1360}x${SE_SCREEN_HEIGHT:-1080}"
PROBSIZE=10000
# sleep 10
FFMPEG_COMMAND="ffmpeg -y -f x11grab -video_size ${VIDEOSIZE} -r 30 -probesize ${PROBSIZE} -i ${host}:${DISPLAY_NUM}.0 -codec:v libx264 -preset ultrafast -pix_fmt yuv420p ${OUTPUT_PATH}"
