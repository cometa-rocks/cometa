...
router.register(r'department_bulk_edit', views.DepartmentBulkEditViewSet)
...
router.register(r'features_history/(?P<feature_id>[0-9]+)/(?P<feature_history_id>[0-9]+)', views.FeatureHistoryViewSet)
router.register(r'features_history/(?P<feature_id>[0-9]+)', views.FeatureHistoryViewSet)
