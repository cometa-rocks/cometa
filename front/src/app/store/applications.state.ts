...
export class ApplicationsState {
  ...
  constructor( private _api: ApiService ) { }
    ...
    addApplication({ setState, getState }: StateContext<Application[]>, { app }: Applications.AddApplication) {
    ...
    setApplications({ setState }: StateContext<Application[]>, { apps }: Applications.SetApplications) {
        setState(apps);
    }

    @Action(Applications.UpdateApplication)
    updateApplication({ setState, getState }: StateContext<Application[]>, { app }: Applications.UpdateApplication) {
      setState(
    ...
    removeApplication({ setState, getState }: StateContext<Application[]>, { app_id }: Applications.RemoveApplication) {
        const apps = getState();
