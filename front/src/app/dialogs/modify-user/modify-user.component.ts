...
@Component({
    ...
    standalone: true,
    imports: [MatLegacyDialogModule, ReactiveFormsModule, MatLegacyFormFieldModule, MatLegacyInputModule, DisableAutocompleteDirective, MatLegacySelectModule, NgFor, MatLegacyOptionModule, MatLegacyButtonModule, AmParsePipe, AmDateFormatPipe, SortByPipe, AsyncPipe, KeyValuePipe]
})
