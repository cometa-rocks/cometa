...
@Component({
    ...
    standalone: true,
    imports: [MatLegacyDialogModule, NgIf, ReactiveFormsModule, MatLegacyFormFieldModule, MatLegacyInputModule, DisableAutocompleteDirective, MatLegacySelectModule, NgFor, MatLegacyOptionModule, MatLegacyButtonModule, SortByPipe]
})
