...
export class DocumentServiceFake implements IDocumentService {
  getElementAbsoluteTop: jasmine.Spy = jasmine.createSpy(
    'getElementAbsoluteTop'
  );
  getElementAbsoluteLeft: jasmine.Spy = jasmine.createSpy(
  ...
  isElementBeyondOthers: jasmine.Spy = jasmine.createSpy(
