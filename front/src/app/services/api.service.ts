...
export class ApiService {
  ...
  getFeatureRuns(feature_id: number) {
    return this._http
      .get<PaginatedResponse<FeatureRun>>(
  ...
  getFeature(FeatureID: number, params?) {
    return this._http
      .get<PaginatedResponse<Feature>>(`${this.api}features/${FeatureID}/`, {
        params: params,
      })
      .pipe(
        map(res =>
  ...
  getFeatureSteps(feature_id: number, params?) {
    return this._http
      .get<PaginatedResponse<FeatureStep>>(`${this.base}steps/${feature_id}/`, {
        params: params,
      })
      .pipe(map(res => res.results));
  }
  ...
  removeFeatureResult(
    ...
    return this._http.delete<Success>(
      `${this.api}feature_results/${feature_result_id}/${
