  ...
  CreateFeature: Tour = {
    ...
    steps: [
      // Basic introduction of co.meta
      {
        ...
        description:
          "I'm here to assist you on how to create your first feature.",
        position: 'center',
        previousFn: emptyFn,
        nextFn: emptyFn,
      },
      ...
      // Explain create feature dialog
      {
        ...
        description:
          'A dialog will open with all the details about the new feature, including name, email options, which browsers to run it with, steps definitions, etc.',
        nextFn: emptyFn,
      ...
      // Explain to fill feature basic information
      {
        ...
        description:
          'Here you have to introduce the basic information about the feature.',
        nextFn: emptyFn,
        previousFn: emptyFn,
        position: 'bottom',
      ...
      // Explain to check continue on failure
      {
        ...
        description:
          'Check this if you want to continue the feature steps even on failing steps.',
        nextFn: emptyFn,
        previousFn: emptyFn,
        position: 'bottom',
      ...
      // Explain to set the schedule
      {
        ...
        description:
          'Lastly you can define the schedule, if not defined the feature will run only when you click Run.',
        nextFn: emptyFn,
        previousFn: emptyFn,
        position: 'top',
      ...
      // Explain how to finally create the feature
      {
        ...
        description:
          'Once you have all specificed click CREATE to submit your feature.',
        nextFn: emptyFn,
        previousFn: emptyFn,
        position: 'top',
