...
export class ArchivedRunsPipe implements PipeTransform {
    ...
    @Select(CustomSelectors.GetConfigProperty('internal')) options$: Observable<InternalOptions>;
     ...
     */
    transform(runs: FeatureRun[] | Observable<FeatureRun[]>): Observable<FeatureRun[]> {
