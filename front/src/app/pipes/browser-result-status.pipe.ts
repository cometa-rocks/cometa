...
export class BrowserResultStatusPipe implements PipeTransform {
   ...
   */
  transform(feature_id: number, feature_run_id: number, browser: BrowserstackBrowser) {
    return CustomSelectors.GetFeatureBrowserStatus(feature_id, feature_run_id, browser);
  }
