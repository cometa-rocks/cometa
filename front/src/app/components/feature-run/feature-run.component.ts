...
import { NgClass, NgIf, NgTemplateOutlet, AsyncPipe, TitleCasePipe } from '@angular/common';
...
@Component({
    ...
    standalone: true,
    imports: [LetDirective, NgClass, NgIf, StopPropagationDirective, MatLegacyMenuModule, MatDividerModule, NgTemplateOutlet, MatLegacyTooltipModule, MatLegacyButtonModule, MatIconModule, TranslateModule, AmParsePipe, AmDateFormatPipe, SecondsToHumanReadablePipe, BrowserIconPipe, PercentageFieldPipe, AsyncPipe, TitleCasePipe, PixelDifferencePipe, PdfLinkPipe, FeatureResultPassedPipe]
})
