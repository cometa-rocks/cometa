...
export class AboutComponent {
  ...
  licenses = [
    ...
    [
      ...
      'https://github.com/crisbeto/angular-svg-round-progressbar/blob/master/LICENSE',
      'MIT License',
    ],
    [
      'Nginx',
    ...
    [
      'Imagick',
      'https://github.com/Imagick/imagick/blob/master/LICENSE',
      'Open-Source License',
    ],
    ...
    [
      'Behave',
      'https://github.com/behave/behave/blob/master/LICENSE',
      'BSD License',
    ],
    [
      'Python',
