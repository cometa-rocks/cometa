...
export class StepEditorComponent extends SubSinkAdapter implements OnInit {
  ...
  openDocumentation(stepContent: string) {
    ...
    const stepToDocMap: { [key: string]: string } = {
      ...
      'Maximize the browser': 'browser-actions',
      'I resize the browser to': 'browser-actions',
      'I can resize the browser to': 'browser-actions',
      'I can close the window': 'browser-actions',
      'Close the browser': 'browser-actions',
      'I can switch to new Window': 'browser-actions',
      'I can switch to main Window': 'browser-actions',
      'I switch to default content': 'browser-actions',
      'BrowserTitle is': 'browser-actions',
      'Reload page': 'browser-actions',
      'Fetch Console.log from Browser': 'browser-actions',
      ...
      // AI actions
      'Exec AI agent action': 'ai-actions',
      'Validate current screen to contain': 'ai-actions',
      'Get list of visible objects in the current screen': 'ai-actions',
      'Get information based on': 'ai-actions',
      'Get information from current screen based on': 'ai-actions',
      'Get screenshot and store in the variable': 'ai-actions',
      'Show me variable': 'ai-actions',
      'Assert variable': 'ai-actions',
      ...
      'Loop': 'css-selectors-actions',

      // Feature actions
      'Schedule Job': 'feature-actions',
      'Delete schedule that executed this feature': 'feature-actions',
      ...
      'Lock the screen mobile': 'mobile-actions',
      'Unlock the mobile screen': 'mobile-actions',
      'Switch to mobile app context': 'mobile-actions',
      'Go back in mobile': 'mobile-actions',
      'Go to Home in mobile': 'mobile-actions',
      'Open recent apps in mobile': 'mobile-actions',
      'Check if mobile element with text': 'mobile-actions',
      'Perform drag and drop from': 'mobile-actions',
      'Wait for mobile element': 'mobile-actions',
      'Validate text': 'mobile-actions',
      'Fetch mobile device details': 'mobile-actions',
