...
@Component({
    ...
    standalone: true,
    imports: [LetDirective, MtxGridModule, NgIf, MatLegacyProgressSpinnerModule, MatLegacyButtonModule, StopPropagationDirective, MatIconModule, MatLegacyTooltipModule, NgClass, NgSwitch, NgSwitchCase, NgSwitchDefault, NgFor, MatLegacyCheckboxModule, MatLegacyMenuModule, MatDividerModule, AsyncPipe, LowerCasePipe, TranslateModule, AmParsePipe, AmDateFormatPipe, SecondsToHumanReadablePipe, BrowserIconPipe, LoadingPipe, BrowserComboTextPipe, HasPermissionPipe, DepartmentNamePipe, FeatureRunningPipe]
})
